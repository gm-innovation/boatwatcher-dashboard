...
const LOCATION_COORDS: Record<string, { x: number; y: number; label: string }> = {
  ...
  'rio de janeiro':   { x: 490, y: 430, label: 'Rio de Janeiro' },
  'niteroi':          { x: 493, y: 428, label: 'Niterói' },
  'sao goncalo':      { x: 495, y: 426, label: 'São Gonçalo' },
  'angra dos reis':   { x: 475, y: 440, label: 'Angra dos Reis' },
  ...
  'brasfels':         { x: 475, y: 440, label: 'Estaleiro Brasfels' },
  'keppel':           { x: 474, y: 441, label: 'Keppel Fels' },
  'maua':             { x: 492, y: 429, label: 'Estaleiro Mauá' },
  'inhauma':          { x: 490, y: 428, label: 'Estaleiro Inhaúma' },
  'brasa':            { x: 491, y: 429, label: 'Estaleiro Brasa' },
  ...
  'utc':              { x: 492, y: 430, label: 'Estaleiro UTC' },
  'triunfo':          { x: 492, y: 430, label: 'Estaleiro Triunfo' },
  'mac laren':        { x: 493, y: 430, label: 'Estaleiro Mac Laren' },
  'maclaren':         { x: 493, y: 430, label: 'Estaleiro Mac Laren' },
  'alianca':          { x: 492, y: 429, label: 'Estaleiro Aliança' },
  'imbetiba':         { x: 511, y: 409, label: 'Base de Imbetiba' },
